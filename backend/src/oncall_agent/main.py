...
app = FastAPI(
    title="AutoSRE API",
    description="Autonomous Site Reliability Engineering platform. AI-powered infrastructure management with intelligent incident response and automated remediation.",
    version="2.0.0"
)
